...
public class QuestaoTela9_7 extends javax.swing.JFrame {


    public QuestaoTela9_7() {
        super("Questao 9");
        initComponents();
    ...
    private void initComponents() {
        ...
        pergunraLabel2.setText("O que o programa exibirá?");
        getContentPane().add(pergunraLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 630, -1, -1));
        ...
        q4Label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/q9.png"))); // NOI18N
        getContentPane().add(q4Label, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 300, 550, 310));
    ...
    private void dicaButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dicaButton1ActionPerformed
        ...
        try{            
            var questao = dao.buscarQuestao(9);
    ...
    private void confirmarButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarButton2ActionPerformed
                ...
                try(var fw = new FileWriter("q9.txt")){
			fw.write("0");
		}catch(IOException e){                
		}
                var qt = new QuestaoTela10_1();
                qt.setVisible(true);
                dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestaoTela9_7().setVisible(true);
            }
        });
    }
