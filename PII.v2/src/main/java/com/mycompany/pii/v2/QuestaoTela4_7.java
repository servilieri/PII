...
public class QuestaoTela4_7 extends javax.swing.JFrame {


    public QuestaoTela4_7() {
        super("Questao 4");
        initComponents();
    ...
    private void initComponents() {
        ...
        q4Label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/q4.png"))); // NOI18N
        getContentPane().add(q4Label, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 300, 430, 310));
    ...
    private void dicaButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dicaButton1ActionPerformed
        ...
        try{            
            var questao = dao.buscarQuestao(4);
    ...
    private void confirmarButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarButton2ActionPerformed
        try(var fw = new FileWriter("q4.txt")){
			fw.write("0");
		}catch(IOException e){                
		}
        var qt = new QuestaoTela5_1();
        qt.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestaoTela4_7().setVisible(true);
            }
        });
    }
