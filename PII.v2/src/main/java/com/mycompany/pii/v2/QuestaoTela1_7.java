...
public class QuestaoTela1_7 extends javax.swing.JFrame {


    public QuestaoTela1_7() {
        super("Questao 1");
        initComponents();
    ...
    private void initComponents() {
        ...
        pergunraLabel1 = new javax.swing.JLabel();
        ...
        pergunraLabel1.setFont(new java.awt.Font("Comic Sans MS", 0, 36)); // NOI18N
        pergunraLabel1.setText("são manipulados pelos programas durante a sua operação?");
        getContentPane().add(pergunraLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 360, -1, -1));

        pergunraLabel2.setFont(new java.awt.Font("Comic Sans MS", 0, 36)); // NOI18N
        pergunraLabel2.setText("Qual é nome utilizado para definir um ou mais valores que");
    ...
    private void dicaButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dicaButton1ActionPerformed
        ...
        try{            
            var questao = dao.buscarQuestao(1);
    ...
    private void confirmarButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarButton2ActionPerformed
        try(var fw = new FileWriter("q1.txt")){
            fw.write("0");
        }catch(IOException e){                
        }
        
        
        var qt = new QuestaoTela2_1();
        qt.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestaoTela1_7().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel pergunraLabel1;
