...
public class QuestaoTela6_7 extends javax.swing.JFrame {


    public QuestaoTela6_7() {
        super("Questao 6");
        initComponents();
    ...
    private void initComponents() {
        ...
        pergunraLabel2.setText("não há definição de quantas vezes o código será repetido?");
        getContentPane().add(pergunraLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 370, -1, -1));
        ...
        pergunraLabel3.setText("Qual é a melhor estrutura de repetição para se utilzar quando");
    ...
    private void dicaButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dicaButton1ActionPerformed
        ...
        try{            
            var questao = dao.buscarQuestao(6);
    ...
    private void confirmarButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarButton2ActionPerformed
                ...
                try(var fw = new FileWriter("q6.txt")){
			fw.write("0");
		}catch(IOException e){                
		}
                var qt = new QuestaoTela7_1();
                qt.setVisible(true);
                dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestaoTela6_7().setVisible(true);
            }
        });
    }
