...
public class QuestaoTela10_7 extends javax.swing.JFrame {


    public QuestaoTela10_7() {
        super("Questao 10");
        initComponents();
    ...
    private void initComponents() {
        ...
        pergunraLabel4 = new javax.swing.JLabel();
        chanceLabel1 = new javax.swing.JLabel();
        ...
        pergunraLabel3.setText("de forma dinâmica por um programa no decorrer de sua execução.");
        getContentPane().add(pergunraLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 360, -1, -1));

        pergunraLabel4.setFont(new java.awt.Font("Comic Sans MS", 0, 36)); // NOI18N
        pergunraLabel4.setText(" Mecanismo por meio do qual selecionamos as funcionalidades utilizadas ");
        getContentPane().add(pergunraLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, -1, -1));

        chanceLabel1.setFont(new java.awt.Font("Comic Sans MS", 0, 36)); // NOI18N
        chanceLabel1.setText("Acabaram as chances...");
        chanceLabel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 8));
        getContentPane().add(chanceLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 850, -1, -1));

        fundoLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/questao - parte 7.png"))); // NOI18N
    ...
    private void dicaButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dicaButton1ActionPerformed
        ...
        try{            
            var questao = dao.buscarQuestao(10);
    ...
    private void confirmarButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarButton2ActionPerformed
                ...
                try(var fw = new FileWriter("q10.txt")){
			fw.write("0");
		}catch(IOException e){                
		}
                var qt = new DesempenhoFinalTela();
                qt.setVisible(true);
                dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestaoTela10_7().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel chanceLabel1;
    ...
    private javax.swing.JLabel pergunraLabel4;
