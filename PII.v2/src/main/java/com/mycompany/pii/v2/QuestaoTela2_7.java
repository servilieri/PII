...
public class QuestaoTela2_7 extends javax.swing.JFrame {


    public QuestaoTela2_7() {
        super("Questao 2");
        initComponents();
    ...
    private void initComponents() {
        ...
        pergunraLabel2.setText("[String a = \"Hello World\"] Qual é a projeção literal dessa String?");
        getContentPane().add(pergunraLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 340, -1, -1));
    ...
    private void dicaButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dicaButton1ActionPerformed
        ...
        try{            
            var questao = dao.buscarQuestao(2);
    ...
    private void confirmarButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarButton2ActionPerformed
        try(var fw = new FileWriter("q2.txt")){
		fw.write("0");
	}catch(IOException e){                
	}
        var qt = new QuestaoTela3_1();
        qt.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestaoTela2_7().setVisible(true);
            }
        });
    }
