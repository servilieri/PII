...
public class QuestaoTela8_7 extends javax.swing.JFrame {


    public QuestaoTela8_7() {
        super("Questao 8");
        initComponents();
    ...
    private void initComponents() {
        ...
        pergunraLabel3.setText("qual palavra-chave especifica que a função não retorna um valor?");
        getContentPane().add(pergunraLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 360, -1, -1));

        pergunraLabel4.setFont(new java.awt.Font("Comic Sans MS", 0, 36)); // NOI18N
        pergunraLabel4.setText("Quando usado como um tipo de retorno da função,");
    ...
    private void dicaButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dicaButton1ActionPerformed
        ...
        try{            
            var questao = dao.buscarQuestao(8);
    ...
    private void confirmarButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarButton2ActionPerformed
                ...
                try(var fw = new FileWriter("q8.txt")){
			fw.write("0");
		}catch(IOException e){                
		}
                var qt = new QuestaoTela9_1();
                qt.setVisible(true);
                dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuestaoTela8_7().setVisible(true);
            }
        });
    }
